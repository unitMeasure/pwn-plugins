# plugin cloned from wpa-sec plugin by Dadav (33197631+dadav@users.noreply.github.com) #https://github.com/V0r-T3x/pwnagotchi_plugins/blob/main/plugins/banthex.py
            ...
            if 'download_results' in self.options and self.options['download_results']:
                ...
                if os.path.exists(cracked_file):
                    ...
                    if last_check is not None and ((datetime.now() - last_check).seconds / (60 * 60)) < 1:
                        return
                try:
                    self._download_from_wpasec(os.path.join(handshake_dir, 'banthex.cracked.potfile'))
