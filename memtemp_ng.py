# https://github.com/MikelCalvo/pwnagotchi-plugins/blob/master/memtemp_ng.py
...
class MemTemp_ng(plugins.Plugin):
    __GitHub__ = ""
    __author__ = "(edited by: avipars itsdarklikehell bauke.molenaar@gmail.com), https://github.com/xenDE"
    __version__ = "1.0.3"
    __license__ = "GPL3"
    __description__ = "A plugin that will display memory/cpu usage and temperature"
    __name__ = "MemTemp_ng"
    __help__ = "A plugin that will add more details to your screen"
    __dependencies__ = {
        "apt": ["none"],
        "pip": ["scapy"],
    }
